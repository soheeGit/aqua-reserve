      ...
      service.getDetails(detailRequest, function(placeDetail, status) {
        if (status === google.maps.places.PlacesServiceStatus.OK) {
          ...
          content += '<p>' +
                  ...
                  '<a href="https://maps.google.com/maps?daddr=' + lat + ',' + lng + '&amp;ll=" target="_blank">길찾기</a><br>' +
                  '<a href="/reservation?placeName=' + encodeURIComponent(placeDetail.name) + '" target="_blank">예약하기</a>' +
                  '</p>';
